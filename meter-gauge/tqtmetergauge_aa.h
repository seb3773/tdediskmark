#ifndef TQTMETERGAUGE_AA_H
#define TQTMETERGAUGE_AA_H
...
class TQtMeterGaugeAA : public TQWidget {
    TQ_OBJECT
public:
    TQtMeterGaugeAA(TQWidget* parent = 0, const char* name = 0);
...
private:
    ...
    // Circle mask cache — recomputed only when radius changes
    TQBitmap m_circleMask;
    int      m_circleMaskDiameter;
};
